...
//  Client_1.xaml.cs - demonstrates that the project implements a WPF    //
 ...
 *   Build Process
 *   -------------
 *   - Required files:   Client_1.xaml.cs, Client_1.xaml
 *    
 *   Maintenance History
 *   -------------------
 *   ver 1.0 : 20 Nov 2016
...
namespace Remote_TestHarness
{
    ...
    /// </summary>
    public partial class Client_1 : Window
    {
        public string requestFileName { get; set; }
        public string srcPath { get; set; }//Path for test driver and test code dll files
        public Comm<Client_1> comm { get; set; } = new Comm<Client_1>();
        ...
        {
            string filePath = "..\\..\\..\\Client_1\\TestRequests\\";
        ...
        public void Request1_Click(object sender, RoutedEventArgs e)
        {
            ...
            requestFileName = "..\\..\\..\\Client_1\\TestRequests\\" + Request1.Header.ToString();
            srcPath = "..\\..\\..\\TestDriver\\bin\\Debug\\";
            sel = 1;
        ...
        public void Request2_Click(object sender, RoutedEventArgs e)
        {
            ...
            requestFileName = "..\\..\\..\\Client_1\\TestRequests\\" + Request2.Header.ToString();
            srcPath = "..\\..\\..\\TestDriver2\\bin\\Debug\\";
            sel = 2;
            ListenButton.IsEnabled = true;
        }
        ...
        void OnNewMessageHandler(Messages msg)
        {
            ...
            if (msg.from == "TH")
            {
                ...
                {
                    Console.WriteLine("\nFile download error - Requirement 3 - Line 293 Client_1.xaml.cs");
            ...
            if (msg.from == "Repo")
            {
                ...
                {
                    download(files[0]);
                    Console.WriteLine("Downloading the latest file to ../../../Client_1/Logs");
                    //download(files[1]);
                }
            }
            //if (msg.body == "quit")
